    ...
    <div class="profile-hero" v-loading="loading">
      <div class="hero-main">
        ...
        <div class="hero-copy">
          ...
          <h2>{{ profileForm.username || '厨师个人中心' }}</h2>
        </div>
      </div>
      <div class="hero-stats">
        ...
        <div class="stat-card">
          ...
          <span class="stat-value">入驻厨师</span>
        </div>
      </div>
    </div>
...
import { getProfile as getAccountProfile, updateProfile, changePassword } from '@/api/user'
...
.hero-avatar {
  box-shadow: 0 14px 34px rgba(103, 194, 58, 0.20);
}
