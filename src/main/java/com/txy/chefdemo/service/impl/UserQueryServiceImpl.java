...
public class UserQueryServiceImpl implements UserQueryService {
    ...
    public ChefDetailDTO chefDetail(ChefDetailReq req) {
        Preconditions.checkArgument(req != null && req.getChefUserId() != 0L, "厨师不能为空");
        ...
        detail.setChefUserId(profile.getUserId() != null ? profile.getUserId() : 0L);
        ...
        detail.setAge(profile.getAge() != null ? profile.getAge() : 0);
        detail.setGender(ObjectUtils.isNotEmpty(Gender.getByCode(profile.getGender())) ? Gender.getByCode(profile.getGender()).getDesc() : "-");
        detail.setWorkYears(profile.getWorkYears() != null ? profile.getWorkYears() : 0);
        ...
        detail.setPrice(profile.getPrice() != null ? profile.getPrice() : 0L);
        detail.setMinPeople(profile.getMinPeople() != null ? profile.getMinPeople() : 0);
        detail.setMaxPeople(profile.getMaxPeople() != null ? profile.getMaxPeople() : 0);
        ...
        detail.setScore(profile.getScore() != null
    ...
    public ChefTimeDetailResp chefTimeDetail(ChefTimeDetailReq req) {
        ...
        List<ChefAvailableTimeDTO> timeDTOS = times.stream().map(time -> {
            ...
            dto.setId(time.getId() != null ? time.getId() : 0L);
            dto.setStartTime(time.getStartTime() != null ? time.getStartTime() : 0L);
            dto.setEndTime(time.getEndTime() != null ? time.getEndTime() : 0L);
            dto.setStatus(time.getStatus() != null ? time.getStatus() : 0);
            dto.setStatusDesc(time.getStatus() != null && AvailableTimeStatus.getByCode(time.getStatus()) != null
    ...
    public ChefReviewDetailResp chefReviewDetail(ChefReviewDetailReq req) {
        ...
        List<ReviewDTO> reviewDTOS = reviews.stream().map(review -> {
            ...
            dto.setId(review.getId() != null ? review.getId() : 0L);
            dto.setReservationOrderId(review.getReservationOrderId() != null ? review.getReservationOrderId() : 0L);
            ...
            dto.setScore(review.getScore() != null ? String.valueOf(review.getScore() / 100.0) : "-");
            dto.setContent(StringUtils.isNotBlank(review.getContent()) ? review.getContent() : "-");
            dto.setAuditStatus(review.getAuditStatus() != null && ReviewAuditStatus.getByCode(review.getAuditStatus()) != null
            ...
            dto.setCreateTime(review.getCreateTime() != null ? review.getCreateTime() : 0L);
            return dto;
        }).collect(Collectors.toList());
    ...
    private List<ChefCardDTO> buildChefCards(List<ChefProfile> chefProfiles) {
        return chefProfiles.stream().map(chefProfile -> {
            ...
            chefCardDTO.setChefUserId(chefProfile.getUserId() != null ? chefProfile.getUserId() : 0L);
            ...
            chefCardDTO.setPrice(chefProfile.getPrice() != null ? chefProfile.getPrice() : 0L);
            chefCardDTO.setScore(chefProfile.getScore() != null
